-- BERNAUNG — MANAGE FINAL SAVE FIX
-- Jalankan sekali di Supabase SQL Editor setelah schema/default photo tables tersedia.
-- Migration ini menjadi versi final untuk penyimpanan Manage + data undangan publik.
